...
export const ACHIEVEMENTS = [
  ...
  { id: "move_2", title: "First 2 kg", desc: "Moved 2 kg toward your goal.", live: true, test: (s) => s.towardKg >= 2 },
  { id: "move_5", title: "Five Down", desc: "5 kg toward your goal.", live: true, test: (s) => s.towardKg >= 5 },
  { id: "goal_hit", title: "PRIME Achieved", desc: "Reached your goal weight!", live: true, test: (s) => s.goalHit },
];

// "live" achievements reflect current state (e.g. weight progress) and may be
// removed if they stop being true; the rest are permanent once earned.
export const LIVE_IDS = ACHIEVEMENTS.filter((a) => a.live).map((a) => a.id);
